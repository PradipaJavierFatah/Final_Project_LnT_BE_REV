...
<body>
    ...
    <div class="m-5">
        ...
        <form action="/store-barang" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleInputAuthor" class="form-label">Items Category</label>
            ...
            <div class="mb-3">
                <label for="exampleInputName" class="form-label">Items Name</label>
            ...
            <div class="mb-3">
                <label for="exampleInputStock" class="form-label">Total Items</label>
