...
<body>
    ...
    <div class="m-5">
        ...
        <form action="{{route('update', $invoice->id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleInputNomor" class="form-label">Invoice Number</label>
            ...
            <div class="mb-3">
                <label for="exampleInputKategori" class="form-label">Items Category</label>
            ...
            <div class="mb-3">
                <label for="exampleInputKuantitas" class="form-label">Quantity</label>
            ...
            <div class="mb-3">
                <label for="exampleInputAlamat" class="form-label">Shipping Address</label>
            ...
            <div class="mb-3">
                <label for="exampleInputKode" class="form-label">Postal Code</label>
